...
void Multiply_Matrices_f(float *C, float *A, int nrows, int ncols,
                                                          float *B, int mcols)
{
   float  *pB;
   float  *p_B;
...
void Multiply_Matrices_u(float *C, float *A, int nrows, int ncols,
                                                          I16 *B, int mcols)
{
   I16  *pB;
   I16  *p_B;
...
void Multiply_Matrices_u8(float *C, float *A, int nrows, int ncols,
                          I8 *B, int mcols)
{
   I8  *pB;
   I8  *p_B;
