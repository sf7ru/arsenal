...
#define SIZE_0_TO_3         ( 32 * 1024)
#define SIZE_4_TO_4         (128 * 1024)
#define SIZE_5_TO_11        (256 * 1024)
...
static  FLASHBLOCK          gSectors [] =
{
    ...
    { 0x08008000, SIZE_0_TO_3  }, // 1
    { 0x08010000, SIZE_0_TO_3  }, // 2
    { 0x08018000, SIZE_0_TO_3  }, // 3

    { 0x08020000, SIZE_4_TO_4  }, // 4

    { 0x08040000, SIZE_5_TO_11 }, // 5
    { 0x08080000, SIZE_5_TO_11 }, // 6
    { 0x080C0000, SIZE_5_TO_11 }, // 7

#if (BOOTLD_FLASH_SZ_KB == 2048)
    { 0x08100000, SIZE_5_TO_11 }, // 8
    { 0x08140000, SIZE_5_TO_11 }, // 9
    { 0x08180000, SIZE_5_TO_11 }, // 10
    { 0x081C0000, SIZE_5_TO_11 }  // 11
#endif
};
